...
#### BASE_URL (string)
If you like to run a reverse proxy, you can set `BASE_URL` to something like `"ha_configurator/"` to change the base url at which the configurator will make it's api calls.
